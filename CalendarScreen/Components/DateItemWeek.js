...
const DAY_HEIGHT = 35;
export default class DateItemWeek extends Component {
    // // Prop type warnings
    // static propTypes = {
            ...
            <TouchableOpacity
                ...
                style={{
                    height:width / 10, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', backgroundColor:
                        state === 'selected'
                            ? colors.selectedDate
                            : colors.transparent, borderRadius: 8, width: width / 10,marginBottom: Platform.OS === 'android' ?  -2 : 0
                }}
                activeOpacity={1}>
                <View
                    style={{
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        {listCeremon.length > 0 && <View
                            ...
                            <View
                                style={[
                                    {
                                        width: 5, height: 5, borderRadius: 5, backgroundColor: state === 'selected'
                                            ? '#ffffff' : '#004cff'
                                    }]}
                            />
